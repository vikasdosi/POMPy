...
class Github_Login_Functionality_validation(unittest.TestCase):
    ...
    driver = webdriver.Chrome("/Users/vikasdosi/Documents/chromeDriver/chromedriver")
    ...
    def test_Registration(self):
        ...
        self.rp.UserRegistration("Vikas", "Dosi@dosi", "VikasDosi")
